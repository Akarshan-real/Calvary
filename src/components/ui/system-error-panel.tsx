...
function ErrorContent({
  ...
  return (
    <div className="pointer-events-none relative z-0 flex max-w-md flex-col items-center justify-center gap-5 text-center sm:items-start sm:text-start">
      ...
      <Link href={buttonHref} className="pointer-events-auto">
        <Button
          className="group rounded px-5 shadow-[inset_0_2px_4px_0_rgba(255,255,255,0.7),inset_0_-2px_4px_0_rgba(0,0,0,0.2)] dark:shadow-[inset_0_-2px_4px_0_rgba(0,0,0,0.2),inset_0_2px_4px_0_rgba(255,255,255,0.5)] cursor-pointer"
          size="lg"
        >
