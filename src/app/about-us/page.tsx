  ...
  return (
    <div className="min-h-screen bg-[#090b0e] text-white flex flex-col selection:bg-[#ffbe33] selection:text-neutral-950">
      ...
      <main className="flex-1 space-y-24 sm:space-y-32 pb-24">
        ...
        {/* HERO SECTION */}
        {/* ============================================================ */}
        <section className="relative pt-20 sm:pt-28 pb-16 px-6 sm:px-8 max-w-7xl mx-auto w-full text-center">
          {/* Ambient Glow */}
          ...
          <div className="relative space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-base text-neutral-300 leading-relaxed font-light">
              Founded on the belief that extraordinary gastronomy demands uncompromising dedication to quality, our kitchen harmonizes time-honored artisanal culinary techniques with progressive, boundary-pushing creativity. Every plate is meticulously crafted using ethically sourced seasonal ingredients, rare heirloom spices, and house-cured botanicals.
            </p>
          </div>

          {/* Hero Banner Showcase Image */}
          <div className="relative mt-14 max-w-6xl mx-auto rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-neutral-900 aspect-[16/10]">
            <Image
              src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1600&auto=format&fit=crop"
              alt="Calvary Fine Dining Dining Hall"
              fill
              priority
            ...
            <div className="absolute bottom-6 left-6 sm:bottom-10 sm:left-10 text-left">
              <p className="text-xs uppercase tracking-[0.25em] font-extrabold text-[#ffbe33]">The Experience</p>
              <p className="text-xl sm:text-2xl font-bold text-white">Atmosphere Designed to Inspire</p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 sm:px-8 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((chef) => (
              <div
                key={chef.name}
                className="group rounded-3xl overflow-hidden bg-[#12141a]/90 border border-white/10 hover:border-[#ffbe33]/40 transition-all"
              >
        ...
        <section className="px-6 sm:px-8 max-w-5xl mx-auto w-full text-center py-6">
          <div className="relative rounded-3xl bg-gradient-to-b from-white/[0.03] to-transparent border border-white/10 p-8 sm:p-14 overflow-hidden">
            {/* Ambient gold glow */}
