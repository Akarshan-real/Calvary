...
import { getRestaurantSettings, getRestaurantHours } from "@/app/actions/restaurant";
import {
  Mail,
  Phone,
  MapPin,
...
export default async function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#090b0e] text-white flex flex-col selection:bg-[#ffbe33] selection:text-neutral-950">
      ...
      <main className="flex-1 py-16 sm:py-24 px-6 sm:px-8 max-w-7xl mx-auto w-full space-y-16">
        {/* Header Hero */}
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-neutral-400 text-xs sm:text-sm leading-relaxed">
            Have a question about our seasonal menu, planning a private dining reception, or need special dining accommodations? Drop us a line.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-8 rounded-3xl bg-[#12141a]/90 border border-white/10 space-y-6 shadow-xl">
          ...
          <div className="lg:col-span-7">
            <div className="p-8 sm:p-10 rounded-3xl bg-[#12141a]/90 border border-white/10 shadow-2xl space-y-6">
